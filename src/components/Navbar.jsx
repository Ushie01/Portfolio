  ...
  return (
		<div className='flex flex-row items-center justify-between h-20 w-full '>
			<div className='flex flex-col items-center'>
				<p className='font-extrabold text-extrabold text-3xl bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500'>{`{FD}`}</p>
				<p className='text-semibold bg-clip-text text-transparent bg-gradient-to-r from-pink-500 to-violet-500 font-bold'>
					Front Dev
				</p>
			</div>
